...
ds <- readr::read_csv("data/imputed-gain-data.csv",
  col_types = cols(
    gender = col_factor(),
    race = col_factor(),
    codis4 = col_factor()
...
# Run synthpop::syn()
ds_1_syn <- synthpop::syn(ds_1, proper = F, seed = 24)
